...
myArray.forEach(function(item, index, arr){ //item is the first parameter, so its 'i' by default
    // The value of the item is             //You would need to specify waht 'index' and 'arr' are
    if (item % 14 === 0){                   //in order to use them as well.
        console.log(item);
    }
});